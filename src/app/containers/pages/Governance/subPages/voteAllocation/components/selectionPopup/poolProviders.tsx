...
import { selectPoolProviders } from "app/containers/pages/Governance/selectors"
import { GovernancePageActions } from "app/containers/pages/Governance/slice"
import { SelectablePoolProvider } from "app/containers/pages/Governance/types"
...
export const PoolProviders = () => {
  ...
  const providers: SelectablePoolProvider[] = useSelector(selectPoolProviders)
