...
export const VotingPeriodInput = () => {
  ...
  return (
    <TextField
      ...
      helperText={isInvalidPeriod(votingPeriod) ? t(translations.GovernancePage.VotingPeriodShouldBeBetween(), { min: env.MINIMUM_VOTING_PERIOD, max: env.MAXIMUM_VOTING_PERIOD, unit: env.MINIMUM_VOTING_PERIOD_UNIT }) : undefined}
      value={votingPeriod}
      fullWidth
      type='number'
