...
import { selectGaugeContractDomain, selectLastInfoQueryDomain, selectPoolsArrayDomain } from "./selectors";
...
export function* getLastInfo() {
  try {
    ...
    const lastInfoQuery=yield select(selectLastInfoQueryDomain)
    ...
    toast.error("failed to get latest pools and gauges Info");
  }
  finally {
